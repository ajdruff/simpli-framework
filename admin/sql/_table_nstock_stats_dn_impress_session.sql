...
/*Table structure for table `nstock_stats_dn_impress_session` */

DROP TABLE IF EXISTS `nstock_stats_dn_impress_session`;

CREATE TABLE `nstock_stats_dn_impress_session` (

...
<p class="button-controls">
    ...
    <input type="submit" id="{form_name}_{form_counter}_say_hello" class="button-primary" value="Say Hello" name="{form_name}_{form_counter}_say_hello"> <span  class="simpli_forms_response"></span> 

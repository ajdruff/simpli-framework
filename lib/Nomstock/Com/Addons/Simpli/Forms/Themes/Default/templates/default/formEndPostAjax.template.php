...
<p class="button-controls">
    ...
    <input type="submit" id="{form_name}_{form_counter}_post_options_save" class="button-primary" value="Save" name="{form_name}_{form_counter}_post_options_save"> <span  class="simpli_forms_response"></span>

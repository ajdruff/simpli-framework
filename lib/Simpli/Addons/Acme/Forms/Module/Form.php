 ...
 *
 */
class Simpli_Addons_Acme_Forms_Module_Form extends Simpli_Basev1c0_Plugin_Module {
    ...
    public function hookShortcodeElementWithContent($atts, $content, $tag) {
         ...
         *
         * e.g.:
         * [Acme_Forms_options options="enable=Enabled&disable=Click for Disabled"][/Acme_Forms_options]
         *
          [Acme_Forms_options]

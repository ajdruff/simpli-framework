 ...
 *
 */
class Simpli_Addons_Acme_Forms_Module_Theme extends Simpli_Basev1c0_Plugin_Module {
...
//         $this->debug()->log('Set Acme_Forms Theme Directory to : ' . $this->_template_directory);
//        return $this;
//    }

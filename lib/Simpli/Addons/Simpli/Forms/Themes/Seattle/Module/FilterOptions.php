 ...
 *
 */
class Simpli_Addons_Simpli_Forms_Themes_Seattle_Module_FilterOptions extends Simpli_Addons_Simpli_Forms_Module_Filter {
    ...
    protected function _commonFilter($properties) {
        ...
        $atts['value'] = $this->getPlugin()->getModule('Post')->getUserSetting($atts['name']);

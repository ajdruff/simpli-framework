...
//return $this->_base_class_version;
    ...
    public function autoloader($class) { //e.g. class= 'Simpli_Frames_Plugin'
        ...
        $namespaces = array(
            $this->getClassNamespace() . '_Base_' . $base_class_version //base class namespace
...
// do not use the slower 'require_once' since autoload tracks loading.
            ...
            $require_result = require $file; //if you receive a missing file error that points to this line, turn on debug and surround this statement with a 'if file exists' conditional, like this :
//'if (file_exists($file)){$require_result = require $file; }
//you then should receive enough information from debug to find out which class is giving you the problem.

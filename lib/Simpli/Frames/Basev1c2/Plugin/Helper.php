 ...
 */
class Simpli_Frames_Basev1c2_Plugin_Helper implements Simpli_Frames_Basev1c2_Plugin_Helper_Interface {
    ...
    function __construct(Simpli_Frames_Basev1c2_Plugin $plugin) {
//        static $count = 0;
//        $count++;
//        if ($count > 2) {
//

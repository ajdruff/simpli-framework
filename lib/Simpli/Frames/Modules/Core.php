 ...
 *
 */
class Simpli_Frames_Modules_Core extends Simpli_Frames_Basev1c2_Plugin_Module {
     ...
     * To see this output, you must call this method somewhere in your code (place it in config())  and configure the debug module to setMethodFilter('_demoDebug') or setMethodFilter('Simpli_Frames_Module_Core');
     *
     * @param none
     * @return void
     */

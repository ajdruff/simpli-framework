 ...
 *
 */
class Simpli_Frames_Modules_Menu001Snippets extends Simpli_Frames_Base_v1c2_Plugin_PostType {

//Menu910DevExampleCustomPostType
    /**
     * Config
     *
     * Long Description
    ...
    public function config() {
        ...
        $this->registerPostType(
                ...
                , array(
            'label' => 'Simpli Frames Snippets' //A plural descriptive name for the post type marked for translation.
            , 'labels' => array(
                'name' => null // general name for the post type, usually plural. The same as, and overridden by $post_type_object->label
                , 'singular_name' => 'Simpli Frames Snippet' // name for one object of this post type. Defaults to value of name
                , 'menu_name' => 'Simpli Frames' // the menu name text. This string is the name to give menu items. Defaults to value of name
            ...
            , 'description' => 'A snippet of text or html that can be inserted into any post using the Simpli Frames option' // A short descriptive summary of what the post type is
        ...
        if (false)//set to true to show the meta box
            $this->metabox()->addMetaBox(
                    'metabox_post_ajax_options'  //Meta Box DOM ID

 ...
 *
 */
class Simpli_Frames_Modules_Menu10DevGetStarted extends Simpli_Frames_Base_v1c2_Plugin_Menu {
    ...
    public function config() {
        ...
        $this->addMenuPage
                (
                $page_title = $this->plugin()->getName() . ' - Build a Plugin'
                , $menu_title = array('menu' => $this->plugin()->getName(), 'sub_menu' => __('How to Build Your Plugin', $this->plugin()->getTextDomain()))
        ...
        $this->metabox()->addMetaBox(
                'metabox_intro'  //Meta Box DOM ID
                , __('How to Build Your Next WordPress Plugin with the Simpli WP Plugin Builder', $this->plugin()->getTextDomain()) //title of the metabox.

...
class Simpli_Hello_Basev1c0_Plugin_Post extends Simpli_Hello_Basev1c0_Plugin_Helper {
     ...
     * $url='http://example.com?post_type='.getPostTypeRequestVar('my_post_type').'&simpli_hello=edit_post // will result in $url = http://example.com?post_type=___my_post_type&simpli_hello=edit_post
     *
     *
     *
     *

 ...
 */
class Simpli_Hello_Module_Menu03Books extends Simpli_Basev1c0_Plugin_PostType {
...
$this->registerPostType(
        $this->getPlugin()->getSlug() . '_book',
                array(
            'label' => 'Simpli Hello Books' //A plural descriptive name for the post type marked for translation.
            , 'labels' => array(
                'name' => null // general name for the post type, usually plural. The same as, and overridden by $post_type_object->label
                , 'singular_name' => 'Simpli Hello Book' // name for one object of this post type. Defaults to value of name
                , 'menu_name' => 'Simpli Hello' // the menu name text. This string is the name to give menu items. Defaults to value of name
                , 'all_items' => 'Books' //the all items text used in the menu. Default is the Name label
                , 'add_new' => 'Add New Book' // 'Add New' text used in the menu title, and the button in the post editor. The default is Add New for both hierarchical and non-hierarchical types. When internationalizing this string, please use a gettext context matching your post type. Example: _x('Add New', 'product');
                , 'add_new_item' => 'Add New Book' // the add new item text displayed on the menu page itself (not the menu text). Default is Add New Post/Add New Page
                , 'new_item' => 'New Item' // the new item text. Default is New Post/New Page
                , 'view_item' => 'View Book' // the view item text. This appears on the normally labeled 'View Item' button in the post editor page. Default is View Post/View Page
                , 'search_items' => 'Search books' // the search items text. Default is Search Posts/Search Pages
                , 'not_found' => 'No books Found' //the not found text. Default is No posts found/No pages found
                , 'not_found_in_trash' => 'No books found in trash' // the not found in trash text. Default is No posts found in Trash/No pages found in Trash
            ...
            , 'description' => 'A book of text or html that can be inserted into any post using the Simpli Hello option' // A short descriptive summary of what the post type is
